...
# Brrrgrrr Demonstration Script
# This script demonstrates the key features of the Brrrgrrr application
...
curl -s http://localhost:4000/api/products | jq '.[].name'
echo ""

echo "📋 Getting blog posts:"
curl -s http://localhost:4000/api/posts | jq '.[].title'
echo ""
