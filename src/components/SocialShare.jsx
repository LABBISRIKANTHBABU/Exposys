  ...
  return (
    <div className="flex items-center space-x-2">
      ...
      <button 
        ...
        className="w-10 h-10 rounded-full bg-blue-400 text-white flex items-center justify-center hover:bg-blue-500 transition duration-200"
      ...
      <button 
        ...
        className="w-10 h-10 rounded-full bg-gray-200 text-gray-700 flex items-center justify-center hover:bg-gray-300 transition duration-200"
